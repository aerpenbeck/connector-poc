...
import com.example.connectorpoc.ft.model.ModifyPickJobActionAllOf;
 ...
 */
@JsonPropertyOrder({
  ModifyPickJobAction.JSON_PROPERTY_ACTION,
  ModifyPickJobAction.JSON_PROPERTY_STATUS
})
@JsonTypeName("ModifyPickJobAction")
...
public class ModifyPickJobAction extends AbstractModificationAction {
  /**
  ...
  public ModifyPickJobAction action(ActionEnum action) {
  ...
  **/
  ...
  public ModifyPickJobAction status(PickJobStatus status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModifyPickJobAction modifyPickJobAction = (ModifyPickJobAction) o;
    return Objects.equals(this.action, modifyPickJobAction.action) &&
        Objects.equals(this.status, modifyPickJobAction.status) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModifyPickJobAction {\n");
